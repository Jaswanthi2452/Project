...
<body>
    ...
    <div class="content">
<<<<<<< HEAD
        <h1 class="heading-primary">Roller Coaster</h1> <!-- Class for better contrast styling in CSS -->
        <img src="images/1.jpeg" alt="A thrilling roller coaster ride" class="ride-image">
        ...
        <h2 class="heading-secondary">Specifications</h2>
=======
...
<<<<<<< HEAD
        <h2 class="heading-secondary">Safety Information</h2>
        ...
        <h2 class="heading-secondary">Park Hours</h2>
=======
