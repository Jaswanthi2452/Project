...
<<<<<<< HEAD
     ...
     .custom-table th {
        background-color: #e0e0e0; /* Slightly darker gray for contrast */
        color: #333333; /* Darker text color */
    }

    .thead-dark th {
        background-color: #1d1f21; /* Very dark background for contrast */
        color: #FFFFFF;
    }
.bar {
        width: 40px;
...
th { 
    background-color: #00A8CC; /* Wave-like bright blue for header background */
