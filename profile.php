...
<div class="content">
    ...
    <input type="text" name="name" id="name" value="<?= htmlspecialchars($user['name']) ?>" required placeholder="Full Name">

    <label for="email">Email:</label>
    <input type="email" name="email" id="email" value="<?= htmlspecialchars($user['email']) ?>" required placeholder="Email">

    <label for="accessibility">Accessibility Preferences:</label>
    <input type="text" name="accessibility" id="accessibility" value="<?= htmlspecialchars($user['accessibility_preferences']) ?>" placeholder="Accessibility Preferences">

    <label for="password">New Password:</label>
    <input type="password" name="password" id="password" placeholder="New Password"> <!-- New password field -->
