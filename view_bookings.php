...
<head>
    ...
    <title>Admin - View Bookings</title> <!-- Added a meaningful page title -->
                ...
                <tbody>
                    <?php if ($bookings_result->num_rows > 0) {
                        while ($booking = $bookings_result->fetch_assoc()) {
                            echo "<tr>";
                            echo "<td data-label='ID'>" . htmlspecialchars($booking['id']) . "</td>";
                            echo "<td data-label='First Name'>" . htmlspecialchars($booking['first_name']) . "</td>";
                            echo "<td data-label='Email'>" . htmlspecialchars($booking['email']) . "</td>";
                            echo "<td data-label='Ride Service'>" . htmlspecialchars($booking['ride_service']) . "</td>";
                            echo "<td data-label='User ID'>" . htmlspecialchars($booking['user_id']) . "</td>";
                            echo "</tr>";
                        }
                    } else {
