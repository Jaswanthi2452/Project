...
<head>
    ...
    function loadContent(page) {
        ...
        // Add a loading class to the header to prevent shrinking
        ...
        xhr.onload = function() {
            ...
            // Remove the loading class from the header once content is loaded
            header.classList.remove('loading');
        };
        xhr.onerror = function() {
            contentSection.innerHTML = '<p>Failed to load content. Please check your connection.</p>';
            // Remove the loading class if there is an error
            header.classList.remove('loading');
        };
        xhr.send();
    }
